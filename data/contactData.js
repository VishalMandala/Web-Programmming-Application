        ...
        if(newContactus){
            const smtpTrans = nodemailer.createTransport({
              ...
              const mailOpts = {
                ...
                to: email,
                subject: 'Thank You. Your Response has been successfully Received!',
                text: `Your Response has been recorded. We will get back to you shortly! Name: ${name} Email: (${email}) Category: ${category}`
              }
